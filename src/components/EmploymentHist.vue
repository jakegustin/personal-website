<template>
    <div class="bg-blue-800 text-slate-100 py-16">
        <h2 class="flex text-4xl font-bold place-content-center text-center py-5">I've Been Employed at These Organizations</h2>
        <div class="flex justify-center px-80 pb-5 rounded-2xl">
            <ul class="list-none flex flex-col items-center gap-y-3">
                ...
                <li class="text-3xl mb-5 flex flex-row items-center w-full">
                    ...
                    <span class="text-left">Your organization could be <span class="text-teal-400 font-extrabold">next!</span></span>
                </li>
            </ul>
        </div>
    </div>

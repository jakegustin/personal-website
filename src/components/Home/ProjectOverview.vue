...
<template>
    ...
    <div id="projectOverviewContainer" class="flex flex-wrap place-content-center gap-x-10 gap-y-10 pb-24 px-3">
        <RouterLink to="/projects/lapsim">
            <div id="projectLapSimContainer" class="flex flex-col bg-white dark:bg-slate-700 shadow-xl border-2 border-slate-400 w-60 h-80 rounded-2xl overflow-hidden place-items-center hover:scale-110 transition-transform duration-100">
        ...
        <RouterLink to="/projects/portfolio">
            <div id="projectWebsiteContainer" class="flex flex-col bg-white dark:bg-slate-700 shadow-xl border-2 border-slate-400 w-60 h-80 rounded-2xl overflow-hidden place-items-center hover:scale-110 transition-transform duration-100">
        ...
        <RouterLink to="/projects/jade">
            <div id="projectJadeContainer" class="flex flex-col bg-white dark:bg-slate-700 shadow-xl border-2 border-slate-400 w-60 h-80 rounded-2xl overflow-hidden place-items-center hover:scale-110 transition-transform duration-100">

...
<nav class="fixed sm:sticky w-full top-0 z-50 overflow-visible">
    <div>
        <div class="flex flex-col">
            ...
            <div :class="{'translate-y-full pointer-events-none': !menuOn, 'translate-y-0 pointer-events-auto': menuOn}" class="fixed top-0 left-0 w-full text-white flex flex-col justify-center items-center py-5 h-screen gap-y-10 font-sans text-2xl z-10 bg-blue-800 dark:bg-blue-900 transition-all duration-300 ease-in-out">
